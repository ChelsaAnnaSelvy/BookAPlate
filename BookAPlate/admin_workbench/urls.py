...
from .views import (
    HomeView, CustomerListView, CustomerStatus, CustomerDetailsView,
    RestaurantListView, RestaurantStatus, RestaurantDetailsView,
    LogoutView, ChangePasswordView, FacilitiesView, GalleriesView,
    BookingHistoryView, BookingReceiptView, FeedbackList
)
