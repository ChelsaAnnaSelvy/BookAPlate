...
from .views import (
    HomeView, CustomerProfileView, RestaurantListView,
    RestaurantProfileView, TableView, ConfirmBookTableView,
    BookTable, BookingHistoryView, BookingDetailsView,
    LogoutView, CancelBooking, ChangePasswordView,
    FeedBackAndRating, MyFeedbackList
)
...
urlpatterns = [
    ...
    path('rate_us/', FeedBackAndRating, name='rate_us'),
    path('feedbacks/', MyFeedbackList, name='my_feedbacks'),
    path('logout/', LogoutView, name='logout'),
    path('customer_change_password/', ChangePasswordView, name='customer_change_password'),
]

# Include debug-related URL patterns when in DEBUG mode
if settings.DEBUG:
