...
from .views import (
    LoginView, HomeView, ContactView,
    CustomerRegistrationView, RestaurantRegistrationView,
    ForgotPasswordView, VerifyOneTimePassword, ResetPasswordView
)
...
# Check if in DEBUG mode, then include static and media URL patterns
if settings.DEBUG:
